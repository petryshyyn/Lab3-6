...
public class Stationary {
    ...
    public String getHeaders() {
        return "Type of goods, " + "Manufacture of goods, " + "Price of goods, " + "Quality of goods, ";
    }

    public String toCSV() {
        return this.getTypeOfGoods() + ", " + this.getManufactureOfGoods() + ", " + this.getPriceOfGoods() + ", " + this.getQualityOfGoods();
    }
